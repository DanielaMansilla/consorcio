...
Nuestro cliente será la empresa administradora de consorcios. Una empresa Administradora de un Consorcio.
...
interactuar con absolutamente todos los módulos del sistema. El operador puede dar de alta nuevos usuarios y ver reportes. Y no 
el Propietario.

Inicialmente serán tres tipos de usuarios: Admin, Operador y Propietario. Con distintos permisos.

El administrador puede dar de alta/baja nuevos usuarios.
...
puede cancelar su deuda en un solo pago. Las cobranzas e pueden realizar mediante codigo QR, efectivo o mediante la
